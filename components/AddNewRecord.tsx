...
const AddRecord = () => {
  ...
  return (
    <div className='bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-slate-700/50 hover:shadow-2xl'>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-slate-50/50 to-blue-50/50 dark:from-slate-900/10 dark:to-blue-900/10 rounded-xl border border-slate-100/50 dark:border-slate-800/50'>
          {/* Expense Description */}
          <div className='space-y-1.5'>
            ...
            <div className='relative'>
              <input
                ...
                className='w-full pl-3 pr-12 sm:pr-14 py-2.5 bg-white/70 dark:bg-slate-800/70 border-2 border-gray-200/80 dark:border-slate-600/80 rounded-xl focus:ring-2 focus:ring-blue-500/30 focus:bg-white dark:focus:bg-slate-700/90 focus:border-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 text-sm shadow-sm hover:shadow-md transition-all duration-200'
          ...
          <div className='space-y-1.5'>
            ...
            <input
              ...
              name='date'
              id='date'
              className='w-full px-3 py-2.5 bg-white/70 dark:bg-slate-800/70 border-2 border-gray-200/80 dark:border-slate-600/80 rounded-xl focus:ring-2 focus:ring-blue-500/30 focus:bg-white dark:focus:bg-slate-700/90 focus:border-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-gray-100 text-sm shadow-sm hover:shadow-md transition-all duration-200'
              required
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-blue-50/50 to-slate-50/50 dark:from-blue-900/10 dark:to-slate-900/10 rounded-xl border border-blue-100/50 dark:border-blue-800/50'>
          {/* Category Selection */}
          <div className='space-y-1.5'>
            <label
              htmlFor='category'
          ...
          <div className='space-y-1.5'>
            ...
            <div className='relative'>
              ...
              <input
                ...
                className='w-full pl-8 pr-3 py-2.5 bg-white/70 dark:bg-slate-800/70 border-2 border-gray-200/80 dark:border-slate-600/80 rounded-xl focus:ring-2 focus:ring-blue-500/30 focus:bg-white dark:focus:bg-slate-700/90 focus:border-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 text-sm font-semibold shadow-sm hover:shadow-md transition-all duration-200'
                placeholder='0.00'
                required
              />
            </div>
        ...
        <button
          type='submit'
          className='w-full relative overflow-hidden bg-gradient-to-r from-slate-600 via-blue-500 to-indigo-500 hover:from-slate-700 hover:via-blue-600 hover:to-indigo-600 text-white px-4 py-3 sm:px-5 sm:py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl group transition-all duration-300 border-2 border-transparent hover:border-white/20 text-sm sm:text-base'
          disabled={isLoading}
        >
